...
export default async function PrivacyPage({ params }: PrivacyPageProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <FadeInUp>
        <GlassCard>
          <h1 className="text-gradient text-display-lg font-bold bn">{isBn ? "গোপনীয়তা নীতি" : "Privacy Policy"}</h1>
          ...
          <div className="mt-8 space-y-6 text-sm text-muted-foreground leading-relaxed">
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "১. সংগ্রহ করা তথ্য" : "1. Information We Collect"}</h2>
              <p className="mt-2 bn">
                {isBn
            ...
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "২. তথ্যের ব্যবহার" : "2. How We Use Information"}</h2>
              <p className="mt-2 bn">
                {isBn
            ...
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "৩. তথ্য সুরক্ষা" : "3. Data Security"}</h2>
              <p className="mt-2 bn">
                {isBn
            ...
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "৪. কুকিজ" : "4. Cookies"}</h2>
              <p className="mt-2 bn">
                {isBn
            ...
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "৫. তৃতীয় পক্ষ" : "5. Third Parties"}</h2>
              <p className="mt-2 bn">
                {isBn
            ...
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "৬. যোগাযোগ" : "6. Contact"}</h2>
              <p className="mt-2 bn">
                {isBn
