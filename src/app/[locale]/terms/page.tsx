...
export default async function TermsPage({ params }: TermsPageProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <FadeInUp>
        <GlassCard>
          <h1 className="text-gradient text-display-lg font-bold bn">{isBn ? "সেবার শর্তাবলী" : "Terms of Service"}</h1>
          ...
          <div className="mt-8 space-y-6 text-sm text-muted-foreground leading-relaxed">
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "১. সেবা গ্রহণ" : "1. Acceptance of Terms"}</h2>
              <p className="mt-2 bn">
                {isBn
            ...
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "২. ওয়েবসাইট সেবা" : "2. Website Services"}</h2>
              <p className="mt-2 bn">
                {isBn
            ...
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "৩. পেমেন্ট" : "3. Payment"}</h2>
              <p className="mt-2 bn">
                {isBn
            ...
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "৪. ডেলিভারি" : "4. Delivery"}</h2>
              <p className="mt-2 bn">
                {isBn
            ...
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "৫. রিফান্ড" : "5. Refund Policy"}</h2>
              <p className="mt-2 bn">
                {isBn
            ...
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "৬. মেধাস্বত্ব" : "6. Intellectual Property"}</h2>
              <p className="mt-2 bn">
                {isBn
            ...
            <section>
              <h2 className="text-heading-sm font-semibold text-foreground bn">{isBn ? "৭. যোগাযোগ" : "7. Contact"}</h2>
              <p className="mt-2 bn">
                {isBn
