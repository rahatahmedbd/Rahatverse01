    ...
    <div className="mx-auto max-w-7xl px-4">
      ...
      <section className="relative flex min-h-[80vh] flex-col items-center justify-center text-center">
        ...
        <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute top-1/4 left-1/4 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-amber-500/10 blur-3xl" />
          <div className="absolute bottom-1/4 right-1/4 h-64 w-64 translate-x-1/2 translate-y-1/2 rounded-full bg-blue-500/10 blur-3xl" />
        </div>
        ...
        <div className="mb-4">
          <h1 className="text-4xl font-bold text-gradient bn sm:text-5xl md:text-6xl">
            <TextReveal
              text="রাহাত আহমেদ"
              delay={0.5}
            />
