-- Phase 6B: Deeper About narrative from the original profile site
--
-- Brings the public About document in line with the enriched code defaults:
-- the verified biography, education and achievement detail carried over from
-- the earlier static profile site (rahatahmedbd.github.io).
...
--   * Paragraphs, personalInfo and interests are appended ONLY when no
--     matching entry exists yet. Nothing is removed or reordered.
