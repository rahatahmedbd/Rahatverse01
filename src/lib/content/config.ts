...
const DEFAULT_FAQ_CATEGORIES: FaqCategory[] = [
  ...
  { id: "faq-cat-technical", value: "technical", labelBn: "টেকনিক্যাল", labelEn: "Technical", visible: true },
...
const DEFAULT_FAQ_ITEMS: FaqItem[] = [
  ...
  { id: "faq-process", category: "ordering", questionBn: "অর্ডার করার পর কাজ কীভাবে এগিয়ে যায়?", questionEn: "What happens after I place an order?", answerBn: "পাঁচটি ধাপে কাজ সম্পন্ন হয়: ডিসকভার (প্রয়োজন বোঝা), প্ল্যান (স্কোপ ও সময়রেখা), ডিজাইন, ডেভেলপ এবং লঞ্চ। অর্ডার বা প্রজেক্ট রিকোয়েস্ট জমা দেওয়ার পর আমি ইমেইল বা হোয়াটসঅ্যাপে যোগাযোগ করে বিস্তারিত চূড়ান্ত করি।", answerEn: "Work moves through five steps: Discover (understanding your needs), Plan (scope & timeline), Design, Develop and Launch. After you submit an order or a project request, I contact you by email or WhatsApp to finalize the details.", visible: true },
