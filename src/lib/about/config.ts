...
export const DEFAULT_ABOUT_CONFIG: AboutConfig = {
  ...
  achievementsSection: {
    ...
    subtitleBn: "বিজ্ঞান ও প্রযুক্তির জাতীয় আসরে অর্জিত সম্মাননা, শিক্ষাগত সাফল্য এবং সমাজসেবায় স্বীকৃতি",
    subtitleEn: "National science & technology honours, academic results and social recognition",
  },
