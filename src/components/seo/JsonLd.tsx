...
export function getPersonSchema() {
  return {
    ...
    image: SITE_IMAGE,
    description:
      "রাহাত আহমেদ — সুনামগঞ্জ, সিলেট, বাংলাদেশের শিক্ষার্থী, শিক্ষক, রক্তদাতা, BNCC ক্যাডেট ও ওয়েব ডেভেলপার এবং রাহাতভার্সের স্রষ্টা। শিক্ষা, সমাজসেবা ও প্রযুক্তির মাধ্যমে মানুষের পাশে দাঁড়ানোই আমার লক্ষ্য।",
