...
export function getPersonSchema() {
  return {
    ...
    image: SITE_IMAGE,
    description:
      "রাহাত আহমেদ — সুনামগঞ্জ, সিলেট, বাংলাদেশের ওয়েব ডেভেলপার এবং রাহাতভার্সের স্রষ্টা। Next.js, React ও TypeScript দিয়ে আধুনিক ওয়েবসাইট ও ওয়েব অ্যাপ্লিকেশন তৈরি করেন; শিক্ষার্থী, শিক্ষক ও সমাজসেবক হিসেবেও যুক্ত।",
